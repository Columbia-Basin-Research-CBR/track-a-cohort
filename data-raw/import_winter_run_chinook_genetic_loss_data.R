...
#'  @details The script imports the genetic loss data shared by BOR as a flat file `WRGenetic.csv`. 
#'  To calculate cumulative genetic loss, the JPE data is imported via `data` >`JPE_annual_data.R` wrangled via `data-raw` >`import_jpe_annual_data.R`. 
#'  @returns The data frames are returned as a list saved to the `data` folder as `jpe_genetic_loss_data.rda`.
...
jpe_genetic_loss_data <- list(genetic_cumulative_loss_data = genetic_cumulative_loss_data, 
