#' @title Winter-run Chinook Model Setup - Tillotson et al 2022
#' @description This script was shared via BOR request to set-up Tillotson et al 2022 winter run chinook model. 
...
#' @return script is called in `utils_fct_predict_tillotson_model.R` to predict weekly loss for Winter-run Chinook.
