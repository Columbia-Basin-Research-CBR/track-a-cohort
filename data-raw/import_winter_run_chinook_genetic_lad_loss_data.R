#' import genetic and LAD loss data for winter-run chinook
#' @description Current code below includes genetic data which is not QA/QC'd prior to 2020 (data source: BOR). This script should be updated once we can source this genetic and lad data.
