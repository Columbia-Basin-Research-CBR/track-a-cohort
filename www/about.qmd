...
-   To access the final individual plots (.png), navigate to the `_site` folder within the repository. The rendered plots are available in respective species folders, `TAC_insertspecies_figures_files>figure-html`.

-   To render the complete quarto webpage, download the repository to `R` and run the following code in the R console to download all packages required:
