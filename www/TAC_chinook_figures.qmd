...
## Figure 3: Juvenile Production Estimate (JPE) Winter-run Chinook
...
source(here("R/winter_run_chinook_plot_pct_genetic_lad_loss.R"))
```

### Figure 3b. Cumulative percent loss of the JPE


```{r, load_plot_03b, fig.width=10, fig.height=6, echo=FALSE}
source(here("R/winter_run_chinook_plot_genetic_lad_loss.R"))
```