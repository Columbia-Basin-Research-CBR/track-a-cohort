...
```{r, load_plot_04a, fig.width=10, fig.height=7}
...
```{r, load_plot_06, fig.width=10, fig.height=10, fig.cap="The figure shows cumulative loss by BiOp Status and Hydrological Classification Index (HCI). Each quadrant of the faceted plot includes grey lines for historical years, colored lines (blue for wet years, red for dry years) for years within the BiOp status and HCI type, a black line for the current year, and a dashed horizontal line indicating the current cumulative loss maximum."}
...
```{r, load_plot_08, fig.width=10, fig.height=7}
