...
- Issues:
    - Confirm option preferred, update static and interactive plot to reflect choice
...
-   Currently waiting on issues to move forward:
  
  -   Confirm this plot or table is wanted. Confirm firm type of figure and or table (similar to steelhead request)
