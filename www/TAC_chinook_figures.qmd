...
```{r, load_plot4a, fig.width=10, fig.height=6, echo=FALSE}
...
```{r, load_plot4b, fig.width=10, fig.height=6, echo=FALSE}
...
```{r, load_plot5b, echo=FALSE}
source(here("R/winter_run_chinook_plot_count_cumulative_lad_loss_single_year_thesholds.R"))
```
