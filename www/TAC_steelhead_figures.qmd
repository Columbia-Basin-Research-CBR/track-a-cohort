...
-   Issues:
    ...
    -   Confirm mean() is used for all averages within Tillotson et al., code and not rolling average.
        -   Update: NB confirms mean() used for weekly averages in Loss and Salvage Predictor Tool. Tillotson et al., 2022 reports " we aggregated all variables from the daily observations to weekly means.."
